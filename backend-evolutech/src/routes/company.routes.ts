...
router.get('/commissions/adjustments', companyController.listCommissionAdjustments.bind(companyController));
router.post('/commissions/adjustments', companyController.createCommissionAdjustment.bind(companyController));
router.delete('/commissions/adjustments/:adjustmentId', companyController.deleteCommissionAdjustment.bind(companyController));
